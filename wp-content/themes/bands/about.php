...
<p><a href="<?php printf( esc_url( 'mailto:music@bandswp.com' ) ); ?>" class="button-primary"><?php printf( esc_html__( 'Free Support', 'bands' ) ); ?></a>&nbsp;&nbsp;<a href="<?php printf( esc_url( 'https://webguy.io/' ) ); ?>" class="button-primary"><?php printf( esc_html__( 'Hire Me', 'bands' ) ); ?></a></p>
</div>
<div class="postbox" style="padding:0 1em">
