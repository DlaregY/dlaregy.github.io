<section id="hp-headerimg" class="hp-header-img">
	<div class="<?php echo ( get_theme_mod( 'dba_hp_headimg_container', 'container' ) == 'container' ? esc_attr( get_theme_mod( 'dba_hp_headimg_container', 'container' ) ) : esc_attr( get_theme_mod( 'dba_hp_headimg_container', 'container' ) ) . ' px-0' ); ?> dba-hp-header-container">
		<div class="row no-gutters">
			...
			<div class="col-12 col-lg-<?php echo esc_attr( $dfu_busacc_lwidth ); ?> dba-hp-header-img">
				<?php
			...
			<div class="col-12 text-center col-lg-<?php echo esc_attr( $dfu_busacc_rwidth ); ?> align-self-stretch justify-content-center <?php echo ( '12' == $dfu_busacc_lwidth ? '' : 'text-lg-left justify-content-lg-start' ); ?> dba-hp-header-txt">
